...
export async function POST(req: NextRequest) {
  ...
  // Full reset: every upload wipes all existing pune_teams (and, via the
  // on-delete-cascade foreign key, all existing pune_scores) and replaces
  // them with the new file. This only ever touches the Pune tables - the
  // UP "teams"/"scores" tables are untouched.
